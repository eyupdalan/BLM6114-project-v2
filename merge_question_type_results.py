...
def merge_csv_files():
    ...
    csv_files = [
        'gsm8k_tr_question_types_first.csv',
        'gsm8k_tr_question_types_second.csv', 
        'gsm8k_tr_question_types_third.csv',
        'gsm8k_tr_question_types_fourth.csv'
    ]
    ...
    output_file = 'gsm8k_tr_question_types_merged.csv'
